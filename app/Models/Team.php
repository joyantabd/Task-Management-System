...
class Team extends Model
{
    ...
    protected $fillable = ['name','slug','description','status','photo'];
    ...
    const IMAGE_UPLOAD_PATH = 'images/uploads/team/';
    const THUMB_IMAGE_UPLOAD_PATH = 'images/uploads/team/thumb/';
